...
@Table(name="T_02_02", uniqueConstraints = { @UniqueConstraint(name = "T_02_02_UK_01", columnNames = { "F_03" })})
public class MilitaryRank {
	...
	@ManyToOne
    @JoinColumn(name="F_04", foreignKey=@ForeignKey(name="T_02_02_FK_01"), nullable=false)
